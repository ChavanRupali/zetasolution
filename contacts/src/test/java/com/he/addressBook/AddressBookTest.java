...
public class AddressBookTest {
	...
	public void testAddressBook() {
		try {
			...
			/*Contact contactOffice = new Contact("office", "USA");//, phoneNumberHome, addressHome);
			contactOffice.addAddress(addressOffice);
			addressBook.addContact(contactOffice);*/
			//changed here to match expecvtation
			List<Contact> listOfContactAddressUpdate = addressBook.searchByName("Officer");
